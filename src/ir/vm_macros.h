...
#define INT8_PEEK() (((int8_t*)stack_global_get_stack(STACK_INT8))[(*stack_global_get_sp(STACK_INT8)) - 1])
#define INT8_TOP(idx) (((int8_t*)stack_global_get_stack(STACK_INT8))[(*stack_global_get_sp(STACK_INT8)) - 1 - (idx)])
...
#define INT32_TOP(idx) (((int32_t*)stack_global_get_stack(STACK_INT32))[(*stack_global_get_sp(STACK_INT32)) - 1 - (idx)])
...
#define UINT8_PEEK() (((uint8_t*)stack_global_get_stack(STACK_UINT8))[(*stack_global_get_sp(STACK_UINT8)) - 1])
#define UINT8_TOP(idx) (((uint8_t*)stack_global_get_stack(STACK_UINT8))[(*stack_global_get_sp(STACK_UINT8)) - 1 - (idx)])
...
#define UINT16_PEEK() (((uint16_t*)stack_global_get_stack(STACK_UINT16))[(*stack_global_get_sp(STACK_UINT16)) - 1])
#define UINT16_TOP(idx) (((uint16_t*)stack_global_get_stack(STACK_UINT16))[(*stack_global_get_sp(STACK_UINT16)) - 1 - (idx)])
...
#define UINT32_PEEK() (((uint32_t*)stack_global_get_stack(STACK_UINT32))[(*stack_global_get_sp(STACK_UINT32)) - 1])
#define UINT32_TOP(idx) (((uint32_t*)stack_global_get_stack(STACK_UINT32))[(*stack_global_get_sp(STACK_UINT32)) - 1 - (idx)])
...
#define UINT64_PEEK() (((uint64_t*)stack_global_get_stack(STACK_UINT64))[(*stack_global_get_sp(STACK_UINT64)) - 1])
#define UINT64_TOP(idx) (((uint64_t*)stack_global_get_stack(STACK_UINT64))[(*stack_global_get_sp(STACK_UINT64)) - 1 - (idx)])
...
#define BOOL_PEEK() (((_Bool*)stack_global_get_stack(STACK_BOOL))[(*stack_global_get_sp(STACK_BOOL)) - 1])
#define BOOL_TOP(idx) (((_Bool*)stack_global_get_stack(STACK_BOOL))[(*stack_global_get_sp(STACK_BOOL)) - 1 - (idx)])
...
#define CHAR_PEEK() (((char*)stack_global_get_stack(STACK_CHAR))[(*stack_global_get_sp(STACK_CHAR)) - 1])
#define CHAR_TOP(idx) (((char*)stack_global_get_stack(STACK_CHAR))[(*stack_global_get_sp(STACK_CHAR)) - 1 - (idx)])
...
#define BYTE_PEEK() (((unsigned char*)stack_global_get_stack(STACK_BYTE))[(*stack_global_get_sp(STACK_BYTE)) - 1])
#define BYTE_TOP(idx) (((unsigned char*)stack_global_get_stack(STACK_BYTE))[(*stack_global_get_sp(STACK_BYTE)) - 1 - (idx)])
...
#define LONG_PEEK() (((long*)stack_global_get_stack(STACK_LONG))[(*stack_global_get_sp(STACK_LONG)) - 1])
#define LONG_TOP(idx) (((long*)stack_global_get_stack(STACK_LONG))[(*stack_global_get_sp(STACK_LONG)) - 1 - (idx)])
...
#define ULONG_PEEK() (((unsigned long*)stack_global_get_stack(STACK_ULONG))[(*stack_global_get_sp(STACK_ULONG)) - 1])
#define ULONG_TOP(idx) (((unsigned long*)stack_global_get_stack(STACK_ULONG))[(*stack_global_get_sp(STACK_ULONG)) - 1 - (idx)])
...
#define LONG_LONG_PEEK() (((long long*)stack_global_get_stack(STACK_LONG_LONG))[(*stack_global_get_sp(STACK_LONG_LONG)) - 1])
#define LONG_LONG_TOP(idx) (((long long*)stack_global_get_stack(STACK_LONG_LONG))[(*stack_global_get_sp(STACK_LONG_LONG)) - 1 - (idx)])
...
#define SIZE_T_PEEK() (((size_t*)stack_global_get_stack(STACK_SIZE_T))[(*stack_global_get_sp(STACK_SIZE_T)) - 1])
#define SIZE_T_TOP(idx) (((size_t*)stack_global_get_stack(STACK_SIZE_T))[(*stack_global_get_sp(STACK_SIZE_T)) - 1 - (idx)])
...
#define SSIZE_T_PEEK() (((ssize_t*)stack_global_get_stack(STACK_SSIZE_T))[(*stack_global_get_sp(STACK_SSIZE_T)) - 1])
#define SSIZE_T_TOP(idx) (((ssize_t*)stack_global_get_stack(STACK_SSIZE_T))[(*stack_global_get_sp(STACK_SSIZE_T)) - 1 - (idx)])
