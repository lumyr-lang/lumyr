...
const char* opc_name(OpCode op)
{
    switch(op) {
        ...
        case OPC_BOOL_TO_VALUE: return "BOOL_TO_VALUE";
        case OPC_BYTE_TO_VALUE: return "BYTE_TO_VALUE";
        case OPC_CHAR_TO_VALUE: return "CHAR_TO_VALUE";
        case OPC_INT8_TO_VALUE: return "INT8_TO_VALUE";
        case OPC_INT16_TO_VALUE: return "INT16_TO_VALUE";
    case OPC_INT32_TO_VALUE: return "INT32_TO_VALUE";
        case OPC_INT64_TO_VALUE: return "INT64_TO_VALUE";
        case OPC_LONG_TO_VALUE: return "LONG_TO_VALUE";
        case OPC_LONG_DOUBLE_TO_VALUE: return "LONG_DOUBLE_TO_VALUE";
        case OPC_SIZE_T_TO_VALUE: return "SIZE_T_TO_VALUE";
        case OPC_SSIZE_T_TO_VALUE: return "SSIZE_T_TO_VALUE";
        case OPC_UINT8_TO_VALUE: return "UINT8_TO_VALUE";
        case OPC_UINT16_TO_VALUE: return "UINT16_TO_VALUE";
        case OPC_UINT64_TO_VALUE: return "UINT64_TO_VALUE";
        case OPC_ULONG_TO_VALUE: return "ULONG_TO_VALUE";
