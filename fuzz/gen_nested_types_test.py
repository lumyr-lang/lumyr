...
def main():
    ...
    o.append("    n: int;")
    o.append("    func __init__(self, label, n) {")
    o.append("        self.label = label;")
    o.append("        self.n = n;")
    o.append("    }")
    o.append("    func getn(self) {")
    ...
    o.append("    info: map;")
    o.append("    func __init__(self) {")
    o.append("        self.items = [10, 20, 30];")
    o.append("        self.info = {\"a\": 1};")
    o.append("    }")
    o.append("    func total(self) {")
