...
def main():
    ...
    o.append('check(type(gt.nums) == "typed_array", "E2.typed array field");')
    ...
    o.append('check(type(gtc.nums) == "typed_array", "E2.class typed array field");')
    ...
    o.append('check(type(gtt.nums) == "typed_array", "E2.type typed array field");')
