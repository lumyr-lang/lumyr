...
static int lmvar_c = 0;
static int lmvar_d = 0;
...
int main(void){
    ...
    gc_stw_check_fast();
    { Value __v = __stk[__sp-1]; __stk[__sp-1] = lumyr_cast_int(__v); }
    { Value __v = __stk[--__sp]; lmvar_c = (int)((__v).type == VAL_DOUBLE ? (long long)(__v).v.d : (__v).v.i); __stk[__sp++] = __v; }
    __sp--;
    __stk[__sp++] = lumyr_make_string("c = a + b = ");
    { int __pcnt = 1; if(__pcnt <= 0) __pcnt = 1; int __pbase = __sp - __pcnt;
      for(int __pi = 0; __pi < __pcnt; __pi++) { if(__pi > 0) printf(" "); lumyr_print_inline(__stk[__pbase + __pi]); }
      printf("\n"); __sp -= __pcnt; }
    __stk[__sp++] = lumyr_make_int((long long)(int)lmvar_c);
    { int __pcnt = 1; if(__pcnt <= 0) __pcnt = 1; int __pbase = __sp - __pcnt;
      for(int __pi = 0; __pi < __pcnt; __pi++) { if(__pi > 0) printf(" "); lumyr_print_inline(__stk[__pbase + __pi]); }
      printf("\n"); __sp -= __pcnt; }
    __stk[__sp++] = lumyr_make_string("\\n");
    ...
    { Value __v = __stk[__sp-1]; __stk[__sp-1] = lumyr_cast_int(__v); }
    { Value __v = __stk[--__sp]; lmvar_d = (int)((__v).type == VAL_DOUBLE ? (long long)(__v).v.d : (__v).v.i); __stk[__sp++] = __v; }
    __sp--;
    __stk[__sp++] = lumyr_make_string("d = a * b = ");
    gc_stw_check_fast();
    { int __pcnt = 1; if(__pcnt <= 0) __pcnt = 1; int __pbase = __sp - __pcnt;
      for(int __pi = 0; __pi < __pcnt; __pi++) { if(__pi > 0) printf(" "); lumyr_print_inline(__stk[__pbase + __pi]); }
      printf("\n"); __sp -= __pcnt; }
    __stk[__sp++] = lumyr_make_int((long long)(int)lmvar_d);
    { int __pcnt = 1; if(__pcnt <= 0) __pcnt = 1; int __pbase = __sp - __pcnt;
      for(int __pi = 0; __pi < __pcnt; __pi++) { if(__pi > 0) printf(" "); lumyr_print_inline(__stk[__pbase + __pi]); }
      printf("\n"); __sp -= __pcnt; }
    __stk[__sp++] = lumyr_make_string("\\n");
    ...
    { int __pcnt = 1; if(__pcnt <= 0) __pcnt = 1; int __pbase = __sp - __pcnt;
      for(int __pi = 0; __pi < __pcnt; __pi++) { if(__pi > 0) printf(" "); lumyr_print_inline(__stk[__pbase + __pi]); }
      printf("\n"); __sp -= __pcnt; }
    __stk[__sp++] = lumyr_make_string("arr[3] = ");
    { int __pcnt = 1; if(__pcnt <= 0) __pcnt = 1; int __pbase = __sp - __pcnt;
      for(int __pi = 0; __pi < __pcnt; __pi++) { if(__pi > 0) printf(" "); lumyr_print_inline(__stk[__pbase + __pi]); }
      printf("\n"); __sp -= __pcnt; }
    __stk[__sp++] = lmvar_arr;
    ...
    { int __pcnt = 1; if(__pcnt <= 0) __pcnt = 1; int __pbase = __sp - __pcnt;
      for(int __pi = 0; __pi < __pcnt; __pi++) { if(__pi > 0) printf(" "); lumyr_print_inline(__stk[__pbase + __pi]); }
      printf("\n"); __sp -= __pcnt; }
    __stk[__sp++] = lumyr_make_string("arr[4] = ");
    { int __pcnt = 1; if(__pcnt <= 0) __pcnt = 1; int __pbase = __sp - __pcnt;
      for(int __pi = 0; __pi < __pcnt; __pi++) { if(__pi > 0) printf(" "); lumyr_print_inline(__stk[__pbase + __pi]); }
      printf("\n"); __sp -= __pcnt; }
    __stk[__sp++] = lmvar_arr;
    ...
    __stk[__sp++] = lumyr_make_int(100);
    gc_stw_check_fast();
    { Value __arr = __stk[__sp-3], __idx = __stk[__sp-2], __val = __stk[__sp-1]; __stk[__sp-3] = lumyr_array_set(__arr, __idx, __val); __sp -= 2; }
    __sp--;
    __stk[__sp++] = lumyr_make_string("arr[0] after assign = ");
    { int __pcnt = 1; if(__pcnt <= 0) __pcnt = 1; int __pbase = __sp - __pcnt;
      for(int __pi = 0; __pi < __pcnt; __pi++) { if(__pi > 0) printf(" "); lumyr_print_inline(__stk[__pbase + __pi]); }
      printf("\n"); __sp -= __pcnt; }
    __stk[__sp++] = lmvar_arr;
